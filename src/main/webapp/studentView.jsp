    ...
    <div id="sub_content">
      <form class="row g-3 mt-3 ms-2" action="StudentSearchController" method="get">
        ...
        <div class="col-auto">
          ...
          <input type="text" class="form-control" id="inputPassword2" placeholder="Student Name" name="studentName">
        </div>
        <div class="col-auto">
            <label for="inputPassword2" class="visually-hidden">Course</label>
            <input type="text" class="form-control" id="inputPassword2" placeholder="Need to update" disabled>
          </div>
        <div class="col-auto">
