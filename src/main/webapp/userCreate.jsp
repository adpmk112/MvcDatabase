    ...
    <div id="sub_content">
        <form">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="email" class="form-control" id="email" value="user123@gmail.com" name="email">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="name" value="user123" name="password">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="confirmPassword" value="user123" name="confirmPassword">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
