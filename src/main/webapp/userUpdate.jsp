    ...
    <div id="sub_content">
        ...
        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Update</h2>
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="email" class="form-control" id="id" value="${fetchData.id }" name="id" readonly="readonly">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="email" class="form-control" id="email" value="${fetchData.email }" name="email" >
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="name" value="${fetchData.password }" name="password">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = 'userView.jsp';">
                Back
            </button>
