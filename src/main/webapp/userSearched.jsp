    ...
    <div id="sub_content">
        ...
        <table class="table table-striped" id="stduentTable">
            ...
            <tr>
               ...
               <tr>      
                    <td>${searchedUserDto.id}</td>
                    <td>${searchedUserDto.email}</td>
            <td>
                    <a href="UserFetchController?fetchId=${searchedUserDto.id}"><button type="button" class="btn btn-success  ">
                        Update
                    </button></a>
                </td>
                <td>
               <a href="UserDeleteController?deleteId=${searchedUserDto.id}"><button type="submit" class="btn btn-secondary mb-3" data-bs-toggle="modal"
